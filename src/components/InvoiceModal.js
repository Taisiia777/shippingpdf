...
async function GenerateInvoice(props) {
  ...
  const pdfFont = await pdfDoc.embedFont(StandardFonts.Helvetica); // Встраивание шрифта
  const textSize = 8; // Размер шрифта
  const maxWidth = 280; // Ограничение по ширине текста
  ...
  drawTextWithWrapping(`${props.info.billToEmail}`, 25, height - 135);
  drawTextWithWrapping(`${props.info.billToAddress}`, 25, height - 210);
  drawTextWithWrapping(`${props.info.billFrom}`, 445, height - 35);
  drawTextWithWrapping(`${props.info.billFromEmail}`, 460, height - 55);
  drawTextWithWrapping(`${props.info.billFromAddress}`, 25, height - 275);
  drawTextWithWrapping(`${props.info.voyage}`, 175, height - 275);
  drawTextWithWrapping(`${props.info.port}`, 25, height - 295);
  drawTextWithWrapping(`${props.info.portTo}`, 175, height - 295);
  drawTextWithWrapping(`${props.info.place}`, 325, height - 290);
  props.items.map((item, i) => {
    ...
    drawTextWithWrapping(`KGs`, 450, yPosition);     // Позиция для цены
    drawTextWithWrapping(`${item.price}`, 450, yPosition - 10);     // Позиция для цены
    drawTextWithWrapping(`${item.description}`, 160, yPosition); // Позиция для описания
    drawTextWithWrapping(`HS CODE: ${item.hs}`, 160, yPosition - 20); // Позиция для описания
    drawTextWithWrapping(`ED NO ${item.ed}`, 160, yPosition - 40); // Позиция для описания

  });
  drawTextWithWrapping(`CONTAINER NO`, 25, height - 540); // Позиция для описания
  drawTextWithWrapping(`SEAL NO`, 135, height - 540); // Позиция для описания
  drawTextWithWrapping(`PACKAGES(UNIT)`, 225, height - 540); // Позиция для описания
  drawTextWithWrapping(`GR. WEIGHT`, 335, height - 540); // Позиция для описания
  ...
  drawTextWithWrapping(`${props.info.freight}`, 25, height - 630);
  drawTextWithWrapping(`${props.info.issue}`, 175, height - 705);
  drawTextWithWrapping(`${props.info.slr}`, 420, height - 780);
